...
class EpisodeSortOrderTest {
    ...
    fun fromKeyParsesFallbackCorrectly() {
        ...
        assertThat(EpisodeSortOrder.fromKey("unknown")).isEqualTo(EpisodeSortOrder.NAME_ASC)
        assertThat(EpisodeSortOrder.fromKey(null)).isEqualTo(EpisodeSortOrder.NAME_ASC)
    }
}
